...
public final class WizardAbilities {
	...
	public static List<AbilityDefinition> create() {
		return List.of(
				...
				new AbilityDefinition("wizard_magic_missile", "Магическая стрела", "3 самонаводящихся снаряда в конусе 25 блоков: 2 магического урона и поджигание. С 5 ур. 4 стрелы, с 10 ур. 5 стрел, с 12 ур. 6 стрел.", 2, 0, 70),
				...
				new AbilityDefinition("wizard_telekinesis", "Телекинез", "Луч 25 блоков: поднимает цель и перетаскивает 6с. На Shift — мощный толчок и досрочное завершение. С 10 ур. захватывает до 3 целей. КД 6с.", 7, 6, 100),
				new AbilityDefinition("wizard_meteor_shower", "Метеоритный дождь", "Зона радиусом 25 блоков в точке прицела. 15с падают 3-5 метеоритов: 10 огненного урона в радиусе 7, ломает блоки как TNT и поджигает.", 9, 0, 160),
				new AbilityDefinition("wizard_careful_mage", "Осторожный маг", "Пассивка (5 ур): автокаст защитных эффектов за ману в опасных ситуациях. Общий КД 60с.", 5, 0, 0, true),
