    ...
    public static List<AbilityDefinition> create() {
        return List.of(
                ...
                new AbilityDefinition("sorcerer_elemental_affinity", "Стихийное родство",
                        "Пассивка: огонь — сопротивление огню; молния — ускорение добычи II; лёд — 1 ед урона ответкой; яд — иммунитет к яду + яд при атаке; гром — редкий удар молнией при атаке.",
                        5, 0, 0, true),

                // Lv6
                new AbilityDefinition("sorcerer_storm_jump", "Грозовой прыжок",
                        "Взлёт на 25 блоков и управляемое падение. При приземлении 8-15 урона и мощный эффект выбранной стихии. 100 маны.", 6, 0, 100),
