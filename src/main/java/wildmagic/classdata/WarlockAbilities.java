...
public final class WarlockAbilities {
	...
	public static List<AbilityDefinition> create() {
		return List.of(
				...
				new AbilityDefinition("warlock_power_word_death", "Слово силы: смерть", "Луч 15 блоков: 5с ритуал с зелёным кругом, обездвиживанием и запретом магии, затем 40 маг. урона. Мана 240.", 12, 0, 240),
